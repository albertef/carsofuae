...
export default {
  ...
  computed: {
    ...
    newSpareApparelInfo() {
      return store.state.home.newSpareApparelInfo;
    },
    utils() {
      return UTILS;
    },
    ...
    async submitPost() {
       if (this.validateNewPostForm()) {
        ...
        if (
          ...
          await this.$store.dispatch("newSpareApparelPost", params);
        } else {
          const alert = {
            show: true,
            type: "error",
            message:
              this.newSpareApparelInfo.message ||
        ...
        if (this.newSpareApparelInfo.status) {
          const alert = {
            show: true,
            type: "success",
        ...
        store.commit("updateNewSpareApparelInfo", {});
      }
    },
  },
};
