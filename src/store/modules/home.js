...
const actions = {
  ...
  async getPostList({ commit }, params) {
    let dataset = {},
      url = `/carsofuae-server/data/get_posts.php?category=${params.category}`
...
const mutations = {
  ...
  updateSelectedBoatSubcategory(state, value) {
    state.selectedBoatSubcategory = value
  },
}
